...
// Layout direto no arquivo (sem imports externos)
      ...
      <div className="w-64 bg-white border-r border-gray-200">
        ...
        <nav className="mt-4 px-3">
          <div className="space-y-1">
            ...
            <NavLink href="/financeiro" icon="💰" active>Financeiro</NavLink>
...
function NavLink({ 
  ...
  return (
    <a
      ...
      `}
    >
      <span className={`text-base mr-3 ${active ? 'text-blue-700' : 'text-gray-400'}`}>
        {icon}
      </span>
