// src/app/financeiro/components/EditTransactionModal.tsx
'use client'

import { useState, useEffect } from 'react'
import { supabase } from '@/lib/supabase'
import { X, Save, Calendar, DollarSign, Tag, Building, FileText } from 'lucide-react'
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">
              Edite os dados da {transaction.type === 'receita' ? 'receita' : 'despesa'}
            </p>
          </div>
          <button
            onClick={onClose}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 text-gray-700 focus:border-transparent"
                required
              />
            </div>
