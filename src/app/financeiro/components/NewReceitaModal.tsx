  ...
  const onSubmit = async (data: ReceitaFormData) => {
    try {
      ...
      const transactionData = {
        ...
        company: clients.find(c => c.id === data.client_id)?.name,
        notes: data.notes,
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div>
                ...
                >
                  ...
                  <option value="receitas_produtos">Receitas de Produtos</option>
                  <option value="receitas_financeiras">Receitas Financeiras</option>
