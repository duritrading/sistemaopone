    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
            ...
            >
              ...
              {suppliers.map(supplier => (
                <option key={supplier.id} value={supplier.id}>
                  {supplier.company_name} {supplier.trading_name && `(${supplier.trading_name})`}
                </option>
              ))}
            </select>
            {errors.supplier_id && (
          ...
          {/* Data de competência e vencimento */}
          ...
          <div className="border border-gray-200 rounded-lg p-4">
            ...
            <p className="mt-2 text-sm text-gray-500">
              Marque esta opção se o valor já foi pago
            </p>
          </div>
              ...
              {activeTab === 'observacoes' && (
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors text-gray-700 resize-none"
                  />
                </div>
              )}
