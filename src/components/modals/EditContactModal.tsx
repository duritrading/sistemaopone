// src/components/modals/EditContactModal.tsx
'use client'

import { useState, useEffect } from 'react'
import { createClient } from '@supabase/supabase-js'
import { X, User, Mail, Phone, Briefcase } from 'lucide-react'
import { ClientContact, ContactType } from '@/types/clients'
...
export default function EditContactModal({ 
  ...
  const [formData, setFormData] = useState({
    ...
    phone: '',
    mobile: '',
    contact_type: 'Profissional' as ContactType,
    is_primary: false
  })
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Atualizando contato:', contactData)
      ...
      const { error: interactionError } = await supabase
        ...
        .insert([{
          ...
          description: `Dados do contato ${contactData.full_name} foram atualizados`,
          outcome: 'Positivo',
        ...
        <form onSubmit={handleSubmit} className="overflow-y-auto max-h-[calc(90vh-140px)]">
          <div className="p-6 space-y-6">
            ...
            <div>
              ...
              {formData.is_primary && !contact.is_primary && (
                <div className="mt-3 p-3 bg-green-50 border border-green-200 rounded-lg">
                  <p className="text-sm text-green-700">
                    <strong>Contato Principal:</strong> Este contato será definido como principal e os outros contatos perderão essa configuração.
                  </p>
                </div>
              )}
            </div>
